...
<head>
  ...
  <title>Courses | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Courses<h1>
      </div>

      <div class="container course-box">
      <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/a-m-minor.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Bachelor of Arts<br> <span style="font-size:18px;">(BA)</span></h4>
    <p class="card-text">Available Seats: 80</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/ba.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/b-com.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Bachelor of Commerce <br><span style="font-size:18px;">(B.Com.)</span></h4>
    <p class="card-text">Available Seats: 80</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/bcom.php" class="btn btn-primary" style="background-color: #A6192E; border: none;color:#fff;">View More</a>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/medical.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Bachelor of Science (Medical)<br><span style="font-size:18px;"> (B. Sc.)</span></h4>
    <p class="card-text">Available Seats: 80</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/bsc-med.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>
</div>
...
<div class="container course-box">
      <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/non-medical.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Bachelor of Science (Non-Medical) <br><span style="font-size:18px;"> (B.Sc. (Non-Medical))</span></h4>
    <p class="card-text">Available Seats: 80</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/bsc-non-med.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/computer-applications.png" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Bachelor of Computer Applications<br><span style="font-size:18px;"> (B.C.A)</span></h4>
    <p class="card-text">Available Seats: 20</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/bca.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/pgd-computer-applications.png" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">PG Diploma in Computer Applications<br><span style="font-size:18px;"> (PGDCA)</span></h4>
    <p class="card-text">Available Seats: 40</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/pgdca.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>
</div>
...
<div class="container course-box">
      <div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/ma-english.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Master of Arts (English) <br><span style="font-size:18px;"> (M.A. (English))</span></h4>
    <p class="card-text">Available Seats: 20</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/ma-english.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>

<div class="card" style="width: 18rem;">
  <img class="card-img-top" src="assets/img/ma-history.jpg" alt="Card image cap">
  <div class="card-body">
    <h4 class="card-title">Master of Arts (History)<br><span style="font-size:18px;"> (M.A. (History))</span></h4>
    <p class="card-text">Available Seats: 30</p>
    <a href="https://gcarki.hp.gov.in/arki-college/courses/ma-history.php" class="btn btn-primary" style="background-color: #A6192E; border: none; color:#fff;">View More</a>
  </div>
</div>
