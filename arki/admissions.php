...
<head>
  ...
  <title>Admissions | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Admissions<h1>
      </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header" style="padding-top: 60px;">
                  <h4><a href="./assets/documents/Admissions.jpg" style="color: #A6192E;">College Prospectus 2023-24.</a></h4>
                  <hr>
                  <h4><a href="./assets/documents/Admissions.jpg" style="color: #A6192E;">Hostel Prospectus 2023-24.</a></h4><br>
                  <a href="" style="text-decoration: none; padding: 10px 25px;; background-color: #A6192E; color: #fff; border-radius: 3px;"><strong>Apply Now</strong></a>
                </div>
              </div>
            </section>
          </div>
