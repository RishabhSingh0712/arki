...
<head>
  ...
  <title>Hostel | Government College Arki</title>
              ...
              <section class="" aria-label="Header Panel" style="height: 90%;">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  <div class="hero__headline">
                    <h1 id="page-title">Hostel</h1>
                  </div>

                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/slider/hostelb.jpg" style="width: 100%;" alt="" />
                  </div>
                </div>
              </section>
              ...
              <!-- <section class=" body-left-layout" aria-label="Introductory Content">
                    <div class="body-left-layout__content">
                      <div class="intro-text">
                        <p>
                          The College has hostel facilities. The hostels and the rooms are technically designed to suit the students’ requirements as the three years of their stay during graduation are very important in their lives. There are no compromises in the quality and standards of the living space and the facilities provided. The hostel facility helps the students in utilizing their valuable time for studies and revisions during the tenure. However, the building is in the temporary possession of CCI (child care Institution).
                        </p>
                      </div>
                    </div>
              </section> -->
            ...
            <div class="container">
                <div class="row" style="align-items: center;">
                   ...
                   <div class="starter-template">
                     ...
                     <div class="col">
                     <img src="./assets/img/new/campus.jpg" style="width: 100%;">
                    </div>
                </div>
          </div>
