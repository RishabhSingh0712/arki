...
<head>
  ...
  <title>Rover and Ranger | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Rover and Ranger<h1>
      </div>
      ...
      <div id="block-system-main" class="block block-system">
        <div class="content">
          <div class="vertical-spacing--more">
            ...
            <section class="max-width-layout" aria-labelledby="features-title" style="padding-top: 4rem;">
              <div class="items-row">
                <div class="items-row__header">
                  <h3 style="padding: 10px; background: #efefef;text-align: center;"><a href="./assets//documents/nss/rovers-and-rangers-activities.pdf">RANGERS ACTIVITIES REPORT 2019-2020 GOVT DEGREE COLLEGE ARKI
                    </a></h3>
                  <p>Activities undertaken by the Bharat Scouts & Guides are primarily based on community development. The college has one unit of this organisation with about 24 students and voluntary membership can be obtained by depositing a fee of Rs. 10/- only.</p>
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          <td>01.</td>
                          <td>Rover Group Leader</td>
                          <td>Mr. Punit Thakur</td>
                        </tr>
                        <tr>
                          <td>02.</td>
                          <td>Ranger Group Leader</td>
                          <td>Ms. Hem Lata</td>
                        </tr>
                      </tbody>
                    </table>
