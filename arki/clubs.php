...
<head>
  ...
  <title>Clubs | Government College Arki</title>
              ...
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate">
                  <div class="hero__headline">
                    <h1 id="page-title">Clubs</h1>
                  </div>

                  <div class="hero__image">
                    <img src="./assets/img/slider/clubb.jpeg" width="1600" height="1067" alt="" />
                  </div>
                </div>
              </section>
            </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">Center and Cell</h2>
                  <p>The Literary Club of Govt. College Arki is committed to tap the effective communication talent among the students and enable their talents with cutting edge. It aims to develop their analytical and creative thinking skills. It offers opportunities to appreciate different types of literature and refine their own literary skills, also developing in them logic and curiosity to know more and to instill in them a confidence to speak well. It is a club made for people who love literature, and want to share their experiences, readings and thoughts with others who have the same interests and talents.</p>

                  <h4>Objectives of the Club</h4>
                  <ol>
                    The Literary Club organizes various activities from time to time:

                    <li>To inculcate within its members elite oratory skills, interpersonal skills, communication skills needed for personal interviews, group discussions, etc.</li>

                    <li>To help the members explore the depths of literary criticism and analysis as well as develop a sense of literary appreciation.</li>

                    <li>To help them groom their personalities so that they feel confident about themselves.</li>

                    <li>To eradicate any fear lingering in one's mind regarding proficiency in any language.</li>

                    <li>To help the members do away with their Stage Fear</li>
                  </ol>
                </div>
              </div>
            </section>
    ...
    <div class="container">
            ...
            <div class="container">
                ...
                <div class="col">
                   ...
                   <div class="col">
                   <div class="starter-template">
                      <h2 class="white-txt">Electoral Literacy Club</h2>
                       <p class="lead white-txt">An Electoral Literacy Club is a platform to engage college students through interesting activities and hands-on experience to sensitize them on their electoral rights and familiarize them with the electoral process of registration and voting. In ELCs various activities and Games are designed to stimulate and motivate students provoking them to think and ask questions. Through ELC, Election Commission of India aims at strengthening the culture of electoral participation among young and future voters.</p>
                     </div>
                     </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row club-fix">
                   <div class="col">
                   <div class="starter-template">
                      <h2 class="white-txt">Road Safety Club . Govt College Arki, Solan, Estd. - 2021</h2>
                       <p class="lead white-txt">As per the directions of Directorate of Higher Education Govt of Himachal Pradesh 
Notification no. EDN-HE(21)F(10)13/2021 – Road Safety dated 17-03-2022 
regarding establishment of Road Safety Clubs in Educational Institutions, a road 
safety club was formed the college to educate the students about the firsthand 
knowledge of traffic rules, signals, road signage, road markings and required 
measures to be taken to avoid undue loss of precious human lives and injuries due 
to the road traffic accidents & also to make them behave like responsible citizens at 
an early age.</p>
                     </div>
                     </div>
                     <div class="col">
                     <img src="./assets/img/new/7(3).jpeg" style="width: 100%;">
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row club-fix">
                <div class="col">
                     <img src="./assets/img/new/7(4).jpeg" style="width: 100%;">
                    </div>
                   <div class="col">
                   <div class="starter-template">
                      <h2 class="white-txt">Anti Drug Abuse Club</h2>
                       <p class="lead white-txt">The club supports the proactive interventions by Government, NGOs, de-addiction centres etc for a drug free world. <br><br>
<strong>Objectives of the Club: </strong>To ensure a drug free campus. To engage the students in anti- narcotic activities. Motivate students to become volunteers of anti-narcotic activities in their life. The club also aims to protect our nation's youth from the horrors of drug abuse, using highly effective tactics to foster their bright futures.<br><br></p>
                     </div>
                     </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row club-fix">
                   <div class="col">
                   <div class="starter-template">
                      <h2 class="white-txt">ECO CLUB</h2>
                       <p class="lead white-txt">Eco Club promotes the participation of students and teachers in knowing and improving our environment. The club aims to create mass awareness and incorporate as many people as possible for understanding our environment.</p>
                     </div>
                     </div>
                     <div class="col">
                     <img src="./assets/img/new/7(5).jpeg" style="width: 100%;">
                    </div>
                </div>
             </div>
