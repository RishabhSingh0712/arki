...
<head>
  ...
  <title>Sports | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid sport-image" style="background-image: url('./img/banner-new.jpeg');">
     <div class="sport-display">
      <p class="sport-text">Sports</p>
    </div>
  </div>

  <div class="container-fluid color-fluid">
    <div class="container" style="padding: 3rem 0rem">
    <h2 style="color:#fff;">Sports</h2>
   <p class="lead" style="color:#fff;">Government Degree College Arki offers a vibrant sports program that plays a pivotal role in the holistic development of its students. With a diverse range of sporting facilities and activities, the college encourages students to actively participate in sports and physical fitness activities. From cricket, football, and basketball to athletics, badminton, and volleyball, the college provides sample opportunities for students to engage in their favorite sports and explore new ones.<br><br>

Regular interclass and intercollegiate tournaments are organized, fostering healthy competition and team spirit among students. Additionally, the college emphasizes the importance of physical fitness through yoga and fitness training sessions, promoting overall well-being and a healthy life style among students. The college also prioritizes the development of leadership skills, discipline, and sportsmanship through its sports program. Students are encouraged to take on leadership roles as team captains, coaches, and organizers, helping them hone their communication, teamwork, and decision-making abilities. Through participation in sports, students learn valuable life lessons such as perseverance, resilience, and determination, which are essential for success in both academic and professional endeavors. Moreover, the college recognizes outstanding achievements in sports through awards and scholarships, motivating students to excel in their athletic pursuits while balancing their academic responsibilities.</p>
</div>
</div>

<div class="container">
                <div class="row" style="align-items: center; margin: 45px 0rem;">
                  <div class="col">
                     <img src="./assets/img/slider/sport2.jpeg" style="width: 100%;">
                    </div>
                   <div class="col">
                   <div class="starter-template">
                       <h2>Gymnasium</h2>
                       <br class="lead">Gymnasium of the college is well equipped. It has a Treadmill T-780, Squat Rack, Rubber Mat, Vibrato comm., Cable Cross Machine, Battling Rope, Kettlebell, Swiss Ball, Power Band, Thera Band, Bench Press, Adidas TRX, Adjustable Bench, Olympic Rod, Weight Plates, Triceps Rope, M Ball, Foam Roller, Wt-Lifting Belt, Yoga mats, Medicine Ball, cross foot trainer and AB Roller Vibrator machine. The work of open air gym and the basket ball court is also in progress.
<br></br>
In the session of 2018 college has provided gym crumbing bombing machine to the students Overall, the sports program at Government Degree College Arki not only promotes physical health and fitness but also instills important values and qualities that contribute to the overall development of students.</p>
                     </div>
                     </div>
                </div>
          </div>
          ...
          <div class="container">
                <div class="row" style="align-items: center; margin: 45px 0rem;">
                   <div class="col">
                   <div class="starter-template">
                       <h2>Recreation Centre</h2>
                       <br class="lead">Recreation centre plays a pivotal role in enhancing our quality of life. By embracing the concept and purpose behind these centres, it unlocks multitude of opportunities for personal growth, social connections, and holistic well being. It helps individual seeking a place to unwind themselves with engaging activities like carom board, chess, table tennis, ludo, yoga meditation facility and also promotes students’ communal unity. Our recreation centre in college is not merely spaces filled with equipment and facilities; they are vibrant ecosystems that promote physical fitness, mental health, and community development.</p>
                     </div>
                     </div>
                     <div class="col">
                     <img src="./assets/img/slider/sports.jpg" style="width: 100%;">
                    </div>
                </div>
          </div>
