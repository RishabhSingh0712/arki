...
<head>
  ...
  <title>About the Library | Government College Arki</title>
      ...
      <div id="block-system-main" class="block block-system">
        <div class="content">
          <div class="vertical-spacing--less">
            <div class="vertical-spacing--less">
              <section class="" aria-label="Header Panel" style="height: 90%;">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  <div class="hero__headline">
                    <h1 id="page-title">About the Library
                    </h1>
                  </div>

                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/library.jpg" style="width: 100%;" alt="" />
                  </div>
                </div>
              </section>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">About the Library</h2>
                  <p>Govt. Degree College Arki has a well equipped library situated on the top floor of the administrative block. The college library offers a calm environment for study and reading away from the hustle bustle of the college. Library has two reading rooms and one office for the Librarian. Keeping in view the need of a modern educational system. One e-resource center equipped with 14 computers with broadband facility is also available. Library users can access e-resources on these computers. The library has 7000 books on different subjects to cater to the needs of its users. To nurture the interest among students for current affairs and general knowledge the library has subscribed to English and Hindi newspapers, magazines and journals. The library also offers online access to e-journals and e-books through INFLIBNET under the NLIST program in which access to 31,35,000+ebooks and 9000+e journals is provided. Beside this users are made aware and encouraged to use many open online educational resources. Library has SOUL (ILMS) software for easy management of its resources. Books are being catalogued in this software and these can be searched by author, title and subject keyword.</p>
                  <p>
                  <ul>
                    <li>Librarian(College Cadre) : 01</li>
                    <li>Assistant Librarian: 01</li>
                    <li>Library Attendant : 01</li>
                  </ul>
                  </p>
                  <p>
                  <h3>Objectives of Library</h3>
                  <ul>
                    <li>To develop a rich collection of reading material useful for library users (students, Teachers and other staff members).</li>
                    <li>To provide full information support to the teaching- learning process in the College.</li>
                    <li>To provide various library services and facilities to the readers.</li>
                    <li>To support research activities of research scholars (Teachers)</li>
                    <li>To support the institution for developing the quality of learning and teaching.</li>
                  </ul>
                  </p>
                  <p>
                  <h3>Library Collection</h3>
                  <ol type="a">
                    <li>Print Resources</li><br>
                    <strong>List of Journals</strong>
                    <ul>
                      <li>Current Sciences</li>
                      <li>Indian Literature</li>
                      <li>Kurukshetra</li>
                      <li>Yojana</li>
                      <li>Ithihas Diwakar</li>
                    </ul><br>
                    <strong>List of Magazines</strong>
                    <ul>
                      <li>Competition Success Review</li>
                      <li>Pratiyogita Darpan</li>
                      <li>Him Pratiyogit Sansar</li>
                      <li>Civil Services Chronicle</li>
                      <li>Week</li>
                      <li>Tell Me Why</li>
                      <li>India Today</li>
                      <li>Outlook</li>
                    ...
                    <strong>List of Newspaper</strong>
                    <ul>
                      <li>The Tribune</li>
                      <li>Amar Ujala</li>
                      <li>Divya Himachal</li>
                      <li>Himachal Dastak</li>
                      <li>Punjab Kesari</li>
                    </ul>
                  </ol>
                  </p>

                  <h3>E-Resource/Digital Library</h3>
                  <p>
                    The college library is registered with the INFLIBNET-NLIST and provided access to e- resources i.e. E books and E journals for the benefit of its users. To make the best use of these e- resources, user ID and password has been created for interested students and staff users. Users can access NLIST and Open educational resources by clicking following links
                  <ul>
                    <li><a href="https://nlist.inflibnet.ac.in/">NLIST</a></li>
                    <li><a href="https://ndl.iitkgp.ac.in/">National Digital Library</a></li>
                    <li><a href="https://www.gutenberg.org/">Project Gutenberg</a></li>
                    <li><a href="https://archive.org/">Internet Archive(Digital Library)</a></li>
                    <li><a href="https://onlinebooks.library.upenn.edu/">Online Books Page</a></li>
                    <li><a href="https://rarebooksocietyofindia.org/">Rare Book Society of India</a></li>
                    <li><a href="https://doabooks.org/en/doab">Directory of Open Access Books</a></li>
                    <li><a href="https://swayamprabha.gov.in/">Swayam Prabha</a></li>
                    <li><a href="https://archive.nptel.ac.in/course.html">NPTEL</a></li>
                    <li><a href="https://epgp.inflibnet.ac.in/">Epgpathshala</a></li>
                    <li><a href="https://onlinecourses.nptel.ac.in/">Swayam-NPTEL(Online Courses)</a></li>
                    <li><a href="https://doaj.org/">Directory of Open Access Journals</a></li>
                    <li><a href="https://openresearchlibrary.org/home">Open Research Library</a></li>
                    <li><a href="https://upscfever.com/">UPSC Fever(Competitive Exam Preparation)</a></li>
                    <li><a href="https://www.cia.gov/the-world-factbook/">World Factbook</a></li>
                  </ul>
                  </p>
                  <h3>Library Services and Facilities</h3>
                  <p>
                    The library has a key role in supporting the academic activities of the institution by establishing, maintaining and promoting the library and information services, both quantitatively and qualitatively. We use the DDC scheme for classification of books. OPAC (Online Public Access Catalogue ) is available for its users
                  </p>
                  <h3>Book Borrowing</h3>
                  <ul>
                    <li>UG Students: 2 books for home study for 2 weeks</li>
                    <li>PG Students: 4 books for home study for 2 weeks</li>
                    <li>Faculty members: 5 books for an academic session.</li>
                    <li>Non teaching staff members: 2 books for 2 weeks.</li>
                  </ul>
                  </p>
                  <h3>Reading Room</h3>
                  <p>
                    Reading room facility is available to students and staff members in the reading room during the library hours i.e. from 10 AM TO 4 PM. The library has seating capacity for about 100 users.
                  </p>
                  <h3>Current Awareness Service (CAS)</h3>
                  <p>
                    The newly arrived books/ list as well as book jackets are displayed to attract the library users. The information for CAS is also taken from the Newspapers (Press cuttings), relevant portions of magazines and books etc.
                  </p>
                  <h3>Internet Facility</h3>
                  <p>
                    14 computers with Internet facility are available in the library for its users. Users can search and read required information.
                  </p>
                  ...
                  <h3>User Programmes</h3>
                  <ul>
                    <li>User Orientations</li>
                    <li>User Awareness on E-Resources</li>
                    <li>Workshop on E-Resources</li>
                    <li>Books and Magazine Exhibitions</li>
                  </ul>
                  </p>
                </div>
              </div>
