...
<head>
  ...
  <title>Teaching Staff | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Teaching Staff<h1>
      </div>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>22.</td>
                          <td>Ms.Ritika Verma</td>
                          <td>Guest Faculty (BCA/PGDCA)</td>
                          <td></td>
                          <td>7807916164</td>
                        </tr>
                        <tr>
                          <td>23.</td>
                          <td>Mr. Devin Sharma</td>
                          <td>Guest Faculty (BCA/PGDCA)</td>
                          <td></td>
                          <td>9418994508</td>
                        </tr>
                        <tr>
                          <td>24.</td>
                          <td>Mr. Khem Raj</td>
                          <td>Guest Faculty (BCA)</td>
                          <td></td>
                          <td>9736415057</td>
                        </tr>
                        <tr>
                          <td>25.</td>
                          <td>Ms. Suman Sharma</td>
                          <td>Guest Faculty (BCA)</td>
                          <td></td>
                          <td>8894907232</td>
                        </tr>
                        <tr>
                          ...
                          <td>Guest Faculty (PGDCA/Add-On)</td>
                          <td></td>
                          <td>9805695806</td>
                        </tr>
                      </tbody>
