...
<head>
  ...
  <title>CSCA | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">CSCA<h1>
      </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header" style="padding-top: 30px;">
                  <p>A CSCA Body was constituted through the process of nomination as per guidelines of Himachal Pradesh University to ensure students’ participation in the administration of the College. The following students became the office-bearers of this body:</p>
