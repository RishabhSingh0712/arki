...
<head>
  ...
  <title>Laboratory Staff | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Laboratory Staff<h1>
      </div>
                  ...
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>04.</td>
                          <td>Sh. Lokesh Kumar</td>
                          <td>Tabla Vadak</td>
                          <td>9015320880</td>
                        </tr>
                        <tr>
                          <td>05.</td>
                          <td>Smt.Parvati Devi</td>
                          <td>LA</td>
                          <td>9816434323</td>
                        </tr>
                        <tr>
                          <td>06.</td>
                          <td>Sh. Ved Prakash</td>
                          <td>LA</td>
                          <td>9418690003</td>
                        </tr>
                      </tbody>
