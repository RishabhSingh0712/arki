...
<head>
  ...
  <title>Message From Librarian | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Message From Librarian<h1>
      </div>
      ...
      <div id="block-system-main" class="block block-system">
        <div class="content">
          <div class="vertical-spacing--more">
            ...
            <div class="body-with-sidebar-layout" style="padding-bottom: 20px;">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      <h3>
                        “Google can bring you back 100,000 answers, but a library can bring you back the right one”<br> <span style="font-size:18px;">-Neil Gaiman</span>
                      </h3>
                      <p>Keeping in pace with the above spirit, Government college Arki Library serves as a steward of a wonderful treasure of academic resources ranging from Books, Periodicals and Newspapers for its user community. Beside Print material our library has access to e-books and e-journals through N-LIST and open access resources. We provide our students and staff with the resources and study environment they need. We are happy to assist them in finding books and searching online resources and accessing facilities.</p>

                      <p>We welcome you all to step into our Library and explore the awesome intellectual resources and have a feel of paradise of knowledge.</p>

                      Thank You<br><br>

                      <strong>Arun Bala</strong><br>
                      <strong>Librarian GC Arki</strong>
                      </p>
                    </div>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  ...
                  <div class="block block-menu-block" style="text-align: center;">
                    ...
                    <img src="assets/img/teachers/arun.jpg" alt="" style="padding: 10px; border: 1px solid #000; width:100%">
                    <h3 style="padding-top:15px">Arun Bala</h3>
                    <h6>Librarian (College Cadre)</h6>
                    <h6>B.A.:BLIB & INF. Sc.: MLIB & INF. Sc.</h6>
                    <br>
                  </div>
