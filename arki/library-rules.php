...
<head>
  ...
  <title>Library Rules | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Library Rules<h1>
      </div>
        ...
        <div class="content">
          <div class="vertical-spacing--less">
              ...
              <!-- <section class="" aria-label="Header Panel" style="height: 90%;">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  <div class="hero__headline">
                    <h1 id="page-title">Library Rules
                    </h1>
                  </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header" style="padding-top: 3rem;">
                  <h3>Identity Card</h3>
                  <p>
                    Identity cards will be issued by the College Librarian on production of admission fee receipt. No one will be permitted to the library without an identity card. Identity card is a legal document, its misuse is an offense and the student responsible for the same is liable for disciplinary action. In case I.card is lost/ misplaced the student must report immediately to the College Librarian. New/ duplicate I card will be issued after 15 days and Rs. 20/- be charged for the same.
                  </p>
                  <h3>Personal Belongings</h3>
                  <p>
                    Personal belongings such as private books, files, bags, Umbrella, purse, shall be deposited by the library users at the property counter before entering the stack area.
                  </p>
                  <h3>Issue of Books and Delay Fine</h3>
                  <p>
                    Library users (student and staff) shall be allowed to use the library and borrow books. In case books issued are not returned within the time limit, book delay fine @ Re. 1=00 per day per book shall be charged from the defaulters. The books will be reissued/ renewed if the same is not in demand by any other user. <br>
                    Before getting the books issued any damage to the books should be pointed out immediately to the counter Assistant/ College Librarian.
                  </p>
                  <h3>Loss/Mutilation of Books</h3>
                  <p>
                    In case of damage or loss of books, the user shall be required to replace the book with the latest edition or pay the actual cost with 20% extra.
                  </p>
                  <h3>Restricted Categories Of Books and Other Reading Materials</h3>
                  <p>
                    Reference books, multi volume books and rare books shall not be lent out for home study. These can be consulted within library premises with the permission of the College Librarian. Journals, Magazines and Newspapers provided in the library Reading room will not be issued to all the above categories of the users.
                  </p>
                  <h3>General Rules</h3>
                  <p>
                    Readers shall maintain proper order and silence in the library. Making noise, spitting, smoking, writing, marking on walls, use of mobiles or doing anything else which may disturb staff and other readers or against the library rules is strictly prohibited.<br>

                    A reader responsible for any damage caused to the library property or reading materials shall be required to replace the same and be penalized under library rules.<br>

                    The issue counter will be closed half an hour earlier so that the persons on the counter may wind up their work for the day and may prepare for the next day.<br>
                  ...
                  <ol>
                    <li>Computerization of library with standard library management software.</li>
                    <li>Inclusion of sufficient information about the library on/ in the College WEBSITE, college magazine, prospects, annual report as well as on the notice board.</li>
                    <li>Arrangement of collection of books on competitive exams and on HIMACHAL separately.</li>
                    <li>Compiling of student’s attendance statistics.</li>
                    <li>Display of newspapers clippings/ employment related information on the notice board periodically.</li>
