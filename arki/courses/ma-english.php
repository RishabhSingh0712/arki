...
<head>
  ...
  <title>Master of Arts (English) | Government College Arki</title>
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-35791 node-type-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Master of Arts (English)<h1>
      </div>
      <nav class="breadcrumbs" aria-label="Breadcrumbs">
    <ol class="breadcrumb-bar">
      <li><a href="../../index.php">Home</a></li>
      <li><a href="../courses.php">Courses</a></li>
      <li class="active">Master of Arts (English)</li>
    </ol>
  </nav>
            ...
            <div class="body-with-sidebar-layout">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      ...
                      <p>Candidates possessing a Bachelor's Degree with English as major or minor or allied subject of HPU or any other University established by law in India or equivalent thereto are eligible for admission to the PG degree programmes.</p>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  <h3 class="small-headline"><a href="ma-english.php" class="active-trail side-text">Master of Arts (English)</a></h3>

                  <div class="block block-menu-block">

                    <ul class="subsite-menu__links">
                      <li class="first leaf active-trail active menu-mlid-8546"><a href="">Short Name: M.A. (English)</a></li>
                      <li class="collapsed menu-mlid-7421"><a href="">Available Seats: 20</a></li>
                    ...
                    <a href="../assets/documents/courses/course-ma-eng.pdf" style="background-color: #A6192E; padding: 10px; text-align: center; color: #fff;"><strong><i class="fa-regular fa-file-pdf" style="color: #fff;"></i>&nbsp;Click Here</strong></a>
                  </div>
                </div>
              </aside>
            </div>
