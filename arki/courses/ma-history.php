...
<head>
  ...
  <title>Master of Arts (History) | Government College Arki</title>
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-35791 node-type-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Master of Arts (History)<h1>
      </div>
      <nav class="breadcrumbs" aria-label="Breadcrumbs">
    <ol class="breadcrumb-bar">
      <li><a href="../../index.php">Home</a></li>
      <li><a href="../courses.php">Courses</a></li>
      <li class="active">Master of Arts (History)</li>
    </ol>
  </nav>
            ...
            <div class="body-with-sidebar-layout">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      <h2>Master of Arts (History)</h2>
                      <h4>Eligibility Criteria</h4>

                      <p>Admission to PG courses will not be on merit basis. It is mandatory for a student to appear in the HPU Entrance Test. As per HP University Notification No. 1-10 HPU/DS 2016, dated 21/7/2016, the first round of admission to PG courses in the campus of HP University, Shimla and the colleges of the state, will be on the basis of Entrance Test, which will be conducted by HP University.</p>

                      <p>Candidates possessing a Bachelor's Degree with History as major or minor or allied subject of HPU or any other University established by law in India or equivalent thereto are eligible for admission to the PG degree programmes.</p>

                      <p>Minimum 50% marks (45% in case of those belonging to Scheduled Caste and Scheduled Tribe categories) in the qualifying exam conducted by HPU.</p>

                      <p>A minimum of 40% marks (35% for SC and ST) in the Entrance Test.</p>

                      <p>Upper age limit for admission to M.A. is 26 years for boys and 28 years for girls as on 1st July, 2024.Age limit relaxation of 3 years is permissible for SC/ST candidates.</p>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  <h3 class="small-headline"><a href="ma-history.php" class="active-trail side-text">Master of Arts (History)</a></h3>

                  <div class="block block-menu-block">

                    <ul class="subsite-menu__links">
                      <li class="first leaf active-trail active menu-mlid-8546"><a href="">Short Name: M.A. (History)</a></li>
                      <li class="collapsed menu-mlid-7421"><a href="">Available Seats: 30</a></li>
                    ...
                    <a href="../assets/documents/courses/course-ma-history.pdf" style="background-color: #A6192E; padding: 10px; text-align: center; color: #fff;"><strong><i class="fa-regular fa-file-pdf" style="color: #fff;"></i>&nbsp;Click Here</strong></a>
                  </div>
                </div>
              </aside>
            </div>
