...
<head>
  ...
  <title>Bachelor of Computer Applications | Government College Arki</title>
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-35791 node-type-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Bachelor of Computer Applications<h1>
      </div>
      <nav class="breadcrumbs" aria-label="Breadcrumbs">
    <ol class="breadcrumb-bar">
      <li><a href="../../index.php">Home</a></li>
      <li><a href="../courses.php">Courses</a></li>
      <li class="active">Bachelor of Computer Applications</li>
    </ol>
  </nav>
            ...
            <div class="body-with-sidebar-layout">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      ...
                      <p>Candidates who have passed 10+2 examination from H.P. Board/CBSE/ICSE or any other examination considered equivalent to 10+2, by the Himachal Pradesh University, Shimla, with 40% Marks (35% marks for SC/ST category), shall be eligible.</p>

                      <p>Maximum age limit for admission to BCA course is 21 years for general category, 24 years for SC/ST category and 23 years for girl candidates, as on the 1st July of the year concerned. The Vice Chancellor may permit age relaxation up to maximum of three months.</p>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  <h3 class="small-headline"><a href="bca.php" class="active-trail side-text">Bachelor of Computer Applications</a></h3>

                  <div class="block block-menu-block">

                    <ul class="subsite-menu__links">
                      <li class="first leaf active-trail active menu-mlid-8546"><a href="">Short Name: B.C.A.</a></li>
                    ...
                    <a href="../assets/documents/courses/course-bca.pdf" style="background-color: #A6192E; padding: 10px; text-align: center; color: #fff;"><strong><i class="fa-regular fa-file-pdf" style="color:#fff;"></i>&nbsp;Click Here</strong></a>
                  </div>
                </div>
              </aside>
            </div>
