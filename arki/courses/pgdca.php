...
<head>
  ...
  <title>PG Diploma in Computer Applications | Government College Arki</title>
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-35791 node-type-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">PG Diploma in Computer Applications<h1>
      </div>
      <nav class="breadcrumbs" aria-label="Breadcrumbs">
    <ol class="breadcrumb-bar">
      <li><a href="../../index.php">Home</a></li>
      <li><a href="../courses.php">Courses</a></li>
      <li class="active">PG Diploma in Computer Applications</li>
    </ol>
  </nav>
            ...
            <div class="body-with-sidebar-layout">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      <h2>PG Diploma in Computer Applications</h2>
                      <h4>Eligibility Criteria</h4>

                      <p>Graduation in any discipline or equivalent of any University established by law in India with50% marks (45% marks in case of Scheduled Caste/Scheduled Tribe).</p>

                      <p>Students appearing in examination of final year of Graduation course may also apply, provided they fulfill eligibility conditions at the time of counseling. The maximum age limit is 28 years on July 1, 2023 for general category candidates and 29 years for candidates belonging to SC/ST category.</p>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  <h3 class="small-headline"><a href="pgdca.php" class="active-trail side-text">PG Diploma in Computer Applications</a></h3>

                  <div class="block block-menu-block">

                    <ul class="subsite-menu__links">
                      <li class="first leaf active-trail active menu-mlid-8546"><a href="">Short Name: PGDCA</a></li>
                      <li class="collapsed menu-mlid-7421"><a href="">Available Seats: 40</a></li>
                    ...
                    <a href="../assets/documents/courses/course-pgdca.pdf" style="background-color: #A6192E; padding: 10px; text-align: center; color: #fff;"><strong><i class="fa-regular fa-file-pdf" style="color: #fff;"></i>&nbsp;Click Here</strong></a>
                  </div>
                </div>
              </aside>
            </div>
