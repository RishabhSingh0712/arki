...
<head>
  ...
  <title>Bachelor of Commerce | Government College Arki</title>
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-35791 node-type-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Bachelor of Commerce<h1>
      </div>
            ...
            <div class="body-with-sidebar-layout">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      ...
                      <p>Any applicant who has passed in the Senior Secondary (+2) Examination (any academic stream i.e. Non-medical or Commerce) with 40% conducted by the H.P Board of School Education or an examination accepted as equivalent thereto by the various bodies of the H.P. University.</p>

                      <p>An applicant who has passed the qualifying examination with commerce stream shall be given preference in admission to B. Com. Programme.</p>

                      <p>The candidates who have been placed under compartment in the 10+2 examination will not be admitted to the college.</p>

                      <p>Only those students who have passed in all subjects in 10+2 from the National Open School (Delhi) shall be admitted to B. Com. I subject to the minimum eligibility conditions stated above.</p>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  <h3 class="small-headline"><a href="bcom.php" class="active-trail side-text">Bachelor of Commerce</a></h3>

                  <div class="block block-menu-block">

                    <ul class="subsite-menu__links">
                      <li class="first leaf active-trail active menu-mlid-8546"><a href="">Short Name: B.Com.</a></li>
                    ...
                    <a href="../assets/documents/courses/course-bcom.pdf" style="background-color: #A6192E; padding: 10px; text-align: center; color: #fff;"><strong><i class="fa-regular fa-file-pdf" style="color:#fff;"></i>&nbsp;Click Here</strong></a>
                  </div>
                </div>
              </aside>
            </div>
