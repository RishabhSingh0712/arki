...
<head>
  ...
  <title>Bachelor of Science (Non-Medical) | Government College Arki</title>
...
<body class="html not-front not-logged-in one-sidebar sidebar-first page-node page-node- page-node-35791 node-type-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Bachelor of Science (Non-Medical)<h1>
      </div>
      <nav class="breadcrumbs" aria-label="Breadcrumbs">
    <ol class="breadcrumb-bar">
      <li><a href="../../index.php">Home</a></li>
      <li><a href="../courses.php">Courses</a></li>
      <li class="active">Bachelor of Science (Non-Medical)</li>
    </ol>
  </nav>
            ...
            <div class="body-with-sidebar-layout">
                ...
                <article id="node-35791" class="vertical-spacing--basic" aria-labelledby="page-title">
                  ...
                  <div class="vertical-spacing--less">
                    <div class="basic-copy">
                      <h2>Bachelor of Science (Non-Medical)</h2>
                      <h4>Eligibility Criteria</h4>

                      <p>Any applicant who has passed in the Senior Secondary (+2) Examination with 45% in Medical conducted by the H.P Board of School Education or an examination accepted as equivalent thereto by the various bodies of the H.P. University.</p>
                      ...
                      <p>Only those students who have passed in all subjects in 10+2 from the National Open School (Delhi) shall be admitted to B.Sc.-I, subject to the minimum eligibility conditions stated above.</p>
              ...
              <aside class="body-with-sidebar-layout__sidebar">
                <div class="subsite-menu" aria-label="Section menu">
                  <h3 class="small-headline"><a href="bsc-non-med.php" class="active-trail side-text">Bachelor of Science (Non-Medical)</a></h3>

                  <div class="block block-menu-block">

                    <ul class="subsite-menu__links">
                      <li class="first leaf active-trail active menu-mlid-8546"><a href="">Short Name: B.Sc. (Non-Medical)</a></li>
                    ...
                    <a href="../assets/documents/courses/course-bsc-non-med.pdf" style="background-color: #A6192E; padding: 10px; text-align: center; color: #fff;"><strong><i class="fa-regular fa-file-pdf" style="color: #fff;"></i>&nbsp;Click Here</strong></a>
                  </div>
                </div>
              </aside>
            </div>
