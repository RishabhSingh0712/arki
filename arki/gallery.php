...
<head>
  ...
  <title>Gallery | Government College Arki</title>
        ...
        <div class="content">
          <div class="vertical-spacing--more">
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header" style="padding-top: 60px; text-align: center;">
                  <h2>Gallery</h2><br><br>
                  <!-- <div class="gallery">
                    <ul>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/IMG-20231229-WA0038.jpg" alt="">
                            <figcaption>IMG-20231229-WA0038</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/PRE-RD-CAMP-AT-BILASPUR.jpg" alt="">
                            <figcaption>PRE-RD-CAMP-AT-BILASPUR</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/PRE-RD-NORTH-ZONE-PARTICIPATION-2023.jpg" alt="">
                            <figcaption>PRE-RD-NORTH-ZONE-PARTICIPATION-2023</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/PANCH-PRAN-PLEDGE.jpg" alt="">
                            <figcaption>PANCH-PRAN-PLEDGE</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/NSS-SPECIAL-CAMP-GLIMPSES.jpg" alt="">
                            <figcaption>NSS-SPECIAL-CAMP-GLIMPSES</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/NSS-SPECIAL-CAMP-GLIMPSES-2022.jpg" alt="">
                            <figcaption>NSS-SPECIAL-CAMP-GLIMPSES-2022</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/NSS-INAUGURATION-SESSION.jpg" alt="">
                            <figcaption>NSS-INAUGURATION-SESSION</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/NIC-PATIALA.jpg" alt="">
                            <figcaption>NIC-PATIALA</figcaption>
                          </figure>
                        </a>
                      </li>
                      <li class="gallery-img">
                        <a href="">
                          <figure>
                            <img src="./assets/img/gallery/NIC-BARIELLY-UP-2023.jpg" alt="">
                            <figcaption>NIC-BARIELLY-UP-2023</figcaption>
                          </figure>
                        </a>
                      </li>
                    </ul>
                  ...
                  <!-- <section id="portfolio" class="portfolio">
                    <div class="container">
                      <div class="section-title">
                        ...
                        <h2>Courses</h2>
                        <p>
                          Immerse yourself in a diverse array of courses spanning from Arts,
                          Science to Commerce and Computer Applications, where each course
                          offers an opprtunity for personal growth, academic excellence and
                          career advancement on your educational journey.
                        </p>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-lg-12 d-flex justify-content-center">
                          <ul id="portfolio-flters">
                            ...
                            <li data-filter=".filter-web">Science</li>
                            <li data-filter=".filter-ca">Computer Application</li>
                          </ul>
                        </div>
                      </div>
                      ...
                      <div class="row portfolio-container">
                        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
                          <img src="assets/img/courses/ba.jpg" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>Bachelor of Arts</h4>
                            <p>B.A.</p>
                            <a href="assets/img/courses/ba.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bachelor of Arts <br> Available Seats: 80"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-web">
                          <img src="assets/img/courses/medical-1.jpeg" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>Bachelor of Science<br />(Medical)</h4>
                            <p>B.Sc. (Medical)</p>
                            <a href="assets/img/courses/medical-1.jpeg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bachelor of Sciences (Medical) <br> Available Seats: 80"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
                          <img src="assets/img/courses/ma-english.jpg" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>Master of Arts (English)</h4>
                            <p>M.A. (English)</p>
                            <a href="assets/img/courses/ma-english.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Master of Arts (English) <br> Available Seats: 20"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-card">
                          <img src="assets/img/courses/commerce-1.png" class="img-fluid" alt="" style="border: 1px solid #000" />
                          <div class="portfolio-info">
                            <h4>Bachelor of Commerce</h4>
                            <p>B.Com.</p>
                            <a href="assets/img/courses/commerce-1.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bachelor of Commerce <br> Available Seats: 80"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-web">
                          <img src="assets/img/courses/non-medical-1.jpg" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>Bachelor of Science (Non-Medical)</h4>
                            <p>B.Sc. (Non-Medical)</p>
                            <a href="assets/img/courses/non-medical-1.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bachelor of Science (Non Medical) <br> Available Seats: 80"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-app">
                          <img src="assets/img/courses/ma-history.jpg" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>Master of Arts (History)</h4>
                            <p>M.A. (History)</p>
                            <a href="assets/img/courses/ma-history.jpg" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Maser of Arts (History) <br> Available Seats: 30"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-ca">
                          <img src="assets/img/courses/computer-applications.png" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>Bachelor of Computer Applications</h4>
                            <p>B.C.A.</p>
                            <a href="assets/img/courses/computer-applications.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Bachelor of Computer Applications <br> Available Seats: 20"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>

                        <div class="col-lg-3 col-md-6 portfolio-item filter-ca">
                          <img src="assets/img/courses/pgd-computer-applications.png" class="img-fluid" alt="" />
                          <div class="portfolio-info">
                            <h4>PG Dip. in Computer Applications</h4>
                            <p>PGDCA</p>
                            <a href="assets/img/courses/pgd-computer-applications.png" data-gallery="portfolioGallery" class="portfolio-lightbox preview-link" title="Post Graduate Diploma in Computer Applications <br> Available Seats: 40"><i class="bx bx-plus"></i></a>
                            <a href="" class="details-link" title="More Details"><i class="bx bx-link"></i></a>
                          </div>
                        </div>
                      </div>
                  ...
                  <div>
                    <a data-fancybox="gallery" href="./assets/img/gallery/IMG-20231229-WA0038.jpg" style="padding: 20px;" data-caption="IMG-20231229-WA0038">
                      <img src="./assets/img/gallery/IMG-20231229-WA0038.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/PRE-RD-NORTH-ZONE-PARTICIPATION-2023.jpg" style="padding: 20px;" data-caption="PRE-RD-NORTH-ZONE-PARTICIPATION-2023">
                      <img src="./assets/img/gallery/PRE-RD-NORTH-ZONE-PARTICIPATION-2023.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/PRE-RD-CAMP-AT-BILASPUR.jpg" style="padding: 20px;" data-caption="PRE-RD-CAMP-AT-BILASPUR">
                      <img src="./assets/img/gallery/PRE-RD-CAMP-AT-BILASPUR.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/PANCH-PRAN-PLEDGE.jpg" style="padding: 20px;" data-caption="PANCH-PRAN-PLEDGE">
                      <img src="./assets/img/gallery/PANCH-PRAN-PLEDGE.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/NSS-SPECIAL-CAMP-GLIMPSES-2022.jpg" style="padding: 20px;" data-caption="NSS-SPECIAL-CAMP-GLIMPSES-2022">
                      <img src="./assets/img/gallery/NSS-SPECIAL-CAMP-GLIMPSES-2022.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/NSS-SPECIAL-CAMP-GLIMPSES.jpg" style="padding: 20px;" data-caption="NSS-SPECIAL-CAMP-GLIMPSES">
                      <img src="./assets/img/gallery/NSS-SPECIAL-CAMP-GLIMPSES.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/NSS-INAUGURATION-SESSION.jpg" style="padding: 20px;" data-caption="NSS-INAUGURATION-SESSION">
                      <img src="./assets/img/gallery/NSS-INAUGURATION-SESSION.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/NIC-PATIALA.jpg" style="padding: 20px;" data-caption="NIC-PATIALA">
                      <img src="./assets/img/gallery/NIC-PATIALA.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>

                    <a data-fancybox="gallery" href="./assets/img/gallery/NIC-BARIELLY-UP-2023.jpg" style="padding: 20px;" data-caption="NIC-BARIELLY-UP-2023">
                      <img src="./assets/img/gallery/NIC-BARIELLY-UP-2023.jpg" width="350" height="250" alt="" style="padding-bottom: 20px;" />
                    </a>
                  </div>
