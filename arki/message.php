...
<head>
  ...
  <title>Principal's Message | Government College Arki</title>
      ...
      <div id="block-system-main" class="block block-system">
        <div class="content">
          <div class="vertical-spacing--more">
            <div class="vertical-spacing--basic" style="background-color:#7E0909;">
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate">

                  <div class="hero__image" style="text-align: center;">
                    <img src="./assets/img/teachers/principal_msg.jpg" width="1400" height="967" alt="" style="display: inline-block;" />
                  </div>
                </div>
              </section>
              ...
              <section class="max-width-layout" aria-labelledby="features-title">
                <div class="items-row">
                  <div class="items-row__header">
                    <h2 id="features-title" style="color:#fff;">Message form Principal</h2>
                    <blockquote>
                      <p style="color:#FFEF98;">The best way to predict your future is to create it.<br> -Abraham Lincoln</p>
                    </blockquote>
                    <p style="color:white;">Govt. College Arki aims to create an atmosphere of excellence, hard work and professionalism in all its undertakings. It is committed to fulfil students’ aspirations, build their self esteem and develop their personality. It strains forward in creating opportunities for the students and helping them to become successful for a better tomorrow. Students are nurtured to grow as honest, confident, creative and disciplined. The College provides the best exposure and opportunities to the students to ensure that all students realize their true potentials.</p>
                    <p  style="color:white;">In achieving our goals we are fortunate to have a team of committed and expert teaching and supporting staff to ensure that the learning environment of our students is the best it can be. The potential effort of the team has brought this institute to the splendid level. Our student community in UG & PG courses is blessed with sufficient infrastructure facilities and selfless service from teachers as well as non -teaching members of the staff. In the realm of learning they enjoy an excellent ambience here. The institute believes in the capacity of every student to grow and excel in their respective fields as everyone is gifted with different talents and infinite potentials. We seek to in still in our students a passion for learning and understanding required for a positive contribution to the society.</p>
                    <p  style="color:white;">Govt. College Arki is a vibrant learning community that encourages supportive and inclusive approach of partnership between students, Parents (PTA), Old Students' Association (OSA) and Higher Education Institute Society (HEIS).The strength of this partnership is certainly reflected in the growth and success of our students.</p>
                    <p  style="color:white;">I am confident that we with the support of students and staff will continue to grow, prosper and reach new heights. I assure you that no stone will be left unturned in helping you to realize your cherished goals.</p>
                    <p  style="color:white;">We warmly welcome you all to Govt. College Arki!</p>
                    <p  style="color:#FFEF98;""><strong>Dr. Sunita Sharma<br>PRINCIPAL</strong></p>
                  </div>
                </div>
              </section>
            </div>
