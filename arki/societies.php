...
<head>
  ...
  <title>Societies | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Societies<h1>
      </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title" style="padding-top: 20px;">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title" style="padding-top: 10px;">Disaster Management Cell</h2>
                  <p>The cell, with the help of Police Personnel and Home Guards, makes sincere efforts to train and produce a team of young, alert, informed volunteers who will be able to work without losing equanimity of mind, in the event of any natural or a man-made disaster.</p>
                  <div class="table-responsive">
                    <h4 id="features-title" style="padding-top: 10px;">Disaster Management Committee</h4>
                    <table class="table">
                      <thead>
                        <tr>
                          <th>S.No.</th>
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>02.</td>
                          <td>Mr. Kailash Chauhan</td>
                          <td>-</td>
                        </tr>
                        <tr>
                          <td>03.</td>
                          <td>Dr. Madhavi Joshi</td>
                          <td>-</td>
                        </tr>
                        <tr>
                          <td>04.</td>
                          <td>Dr. Kamini Sharma</td>
                          <td>-</td>
                        </tr>
                        <tr>
                          <td>05.</td>
