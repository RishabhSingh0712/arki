...
<head>
  ...
  <title>Government College Arki</title>
...
.owl-slide .owl-nav {
  ...
  /*! CSS Used from: http://www.gopinathpgcollege.com/css/bootstrap.min.css */
...
/*! CSS Used from: http://www.gopinathpgcollege.com/fontawesome/css/all.min.css */
...
/*! CSS Used from: http://www.gopinathpgcollege.com/css/default.css */
.mb-30{margin-bottom:30px;}
a{text-decoration:none;}
.hover-zoomin a{display:block;position:relative;overflow:hidden;}
.hover-zoomin img{width:100%;height:auto;-webkit-transition:all 0.5s ease-in-out;-moz-transition:all 0.5s ease-in-out;-o-transition:all 0.5s ease-in-out;-ms-transition:all 0.5s ease-in-out;transition:all 0.5s ease-in-out;}
.hover-zoomin:hover img{-webkit-transform:scale(1.2);-moz-transform:scale(1.2);-o-transform:scale(1.2);-ms-transform:scale(1.2);transform:scale(1.2);}
/*! CSS Used from: http://www.gopinathpgcollege.com/css/style.css */
.fix{overflow:hidden;}
...
a{color:#141b22;outline:medium none;}
a:hover{color:#0767ab;}
h3{font-family:'Jost', sans-serif;color:#141b22;margin-top:0px;font-style:normal;font-weight:600;text-transform:normal;}
h3 a{color:inherit;}
h3{font-size:28px;}
p{margin-bottom:15px;}
::selection{background:#444;color:#fff;text-shadow:none;}
*::placeholder{color:#555555;font-size:14px;opacity:1;}
.courses-item{float:left;margin-left:15px;margin-right:15px;position:relative;background:#f0f7ff;border-radius:4px;transition:all 0.3s ease 0s;}
.courses-item:hover{box-shadow:1px 1.732px 60px 0px rgba(0, 0, 0, 0.1);}
.courses-item:hover .courses-content{background:#fff;}
.courses-content{padding:30px;float:none;position:relative;}
.courses-content .cat{border-radius:4px;background-color:#0767ab;position:absolute;top:-18px;right:30px;color:#fff;padding:5px 10px;}
.courses-content .cat i{margin-right:5px;}
.courses-item .icon img{display:inherit;}
.courses-item .icon{float:right;text-align:right;margin-top:-60px;margin-right:30px;}
.courses-content a{color:#141b22;font-family:'Jost', sans-serif;}
.courses-content a.readmore{color:#0767ab;}
.courses-content a.readmore:hover{color:#141b22;}
.courses-content a:hover{color:#0767ab;}
a,h3,p{overflow-wrap:break-word;}
h3{overflow-wrap:break-word;}
img{max-width:100%;transition:all 0.3s ease-out 0s;}
/*! CSS Used from: Embedded */
.readmore{float:right;font-size:10px;}
.courses-content .cat{border-radius:4px;background-color:#ff7350;position:absolute;top:-18px;right:0;color:#fff;padding:5px 10px;left:0;max-width:200px;text-align:center;display:block;margin:auto;}
.courses-content{text-align:center;}
.readmore{color:#f00;}
a:visited,.courses-content a:visited{color: #000;}
...
::selection{background:#444;color:#fff;text-shadow:none;}
*::placeholder{color:#555555;font-size:14px;opacity:1;}
.event-item .thumb{overflow:hidden;}
.event-content{padding:30px;background:#f0f7ff;position:relative;transition:all 0.5s ease 0s;}
.event-item:hover .event-content{background:#ffffff;color:#000;}
.event-item:hover .event-content h3 a{color:#a6192e;}
.event-content h3{font-size:24px;}
a,h3,p{overflow-wrap:break-word;}
h3{overflow-wrap:break-word;}
img{max-width:100%;transition:all 0.3s ease-out 0s;}
/*! CSS Used from: Embedded */
.event-item .event-content{background:#ffffff;color:#fff;}
.event-item .event-content h3 a{color:#a6192e;}
.event_last .event-content{border: 1px solid #a6192e;
    background: #fff;
    color: #000;}
    .college_intro{background:#a6192e;color:#fff;}
    .college_intro a,   .college_intro p,   .college_intro h2,.college_intro a:hover{color:#fff!important}
    .event_last .event-item .event-content h3 a{    color: #000;}.lined-grid {
    display: grid;
    gap: 4rem 10rem;
    align-items: center;
}
...
</style><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/lightslider/1.1.6/css/lightslider.min.css" integrity="sha512-yJHCxhu8pTR7P2UgXFrHvLMniOAL5ET1f5Cj+/dzl+JIlGTh5Cz+IeklcXzMavKvXP8vXqKMQyZjscjf3ZDfGA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
</head>

<body class="html front not-logged-in no-sidebars page-node page-node- page-node-317536 node-type-home-2020 slid-closed">
  ...
  <div class="coontainer-fluid" style="background-color:#FFEF98; padding:7px 2px;">
            <div class="container">
                <div class="slide-text-header">
                    <p style="margin:0px">Explore our College Prospectus for the academic year 2024-2025.</p>
                    <button style="padding: 5px 11px; border-radius: 3px;">Learn More</button>
                </div>
            </div>
        </div>
  ...
  <ul id="slide" class="hero-slide owl-carousel site-blocks-cover">
      <li class="intro-section" style="background-image: url('./img/1.jpg');">
        <div class="container">
      ...
      <li class="intro-section" style="background-image: url('./img/2.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
      ...
      <li class="intro-section" style="background-image: url('./img/3.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1> Arts and Commerce Block </h1>
            </div>
          </div>
        </div>
</li>
      
      <li class="intro-section" style="background-image: url('./img/4.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1> Park View</h1>
      ...
      <li class="intro-section" style="background-image: url('./img/5.jpg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1 class="text-deco"> Temple View</h1>
            </div>
          </div>
        </div>
</li>
<li class="intro-section" style="background-image: url('./img/banner-new.jpeg');">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center" data-aos="fade-up">
              <h1>Sport</h1>
...
<section class="college_intro">

<div id="orientationTwo" class="col-md-12 p-5" data-boost-padding="some">
                <div class="lined-grid">
                

                  <div class="intro-text center-text">
                    <div class="next-step-links">
                    <h1>Government College Arki</h1>
<p>We taste Immortality, through Knowledge.</p>
                      <div class="item-list">
                        <ul class="list--clean vertical-spacing--less">
                          <li class="first">
                            <a href="./message.php" class="go">Principal's Message</a>
                          </li>
                          <li>
                            <a href="./admissions.php" class="go">Admission and Courses</a>
                          </li>
                          <li class="last">
                            <a href="./campus-life.php" class="go">Student Life</a>
                          </li>
                        </ul>
                      </div>
                    </div>
                  ...
                  <div class="intro-text center-text">
                    ...
                    <h2 class="small-headline" style="font-size: 1.125rem">
                      Admissions Visits
                    </h2>

                    <p>
                      The advent into college life is replete with a sense of exciting adventure in itself.
                    </p>

                    <p><a class="go" href="./campus-life.php">Visit Campus</a></p>
                  </div>
                </div>
              </div>
</section>
<section class="courses pt-5 pb-5 p-relative fix">
  <div class="container-fluid">
    <div class="row">
<div class="col-md-12">
  <div class="mtitle">
<h2 class="Find">Find Your Area of Study</h2>
<p class="Exploring">Exploring Academic Interests and Career Goals</p>
</div>
</div>
...
<ul id="courseslide">
                    <li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/ba.php"><img src="assets/img/ba.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 80</div>
                                <h3><a href="./courses/ba.php"> Bachelor of Arts (B.A)</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/ba.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
                        </div>
</li>
                    ...
                    <li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/bcom.php"><img src="assets/img/bcom.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 80</div>
                                <h3><a href="./courses/bcom.php">Bachelor of Commerce (B.Com)</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/bcom.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
                    ...
                    <li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/bsc-med.php"><img src="assets/img/medical.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 80</div>
                                <h3><a href="./courses/bsc-med.php"> Bachelor of Science (Medical)</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/bsc-med.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
                    ...
                    <li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/bsc-non-med.php"><img src="./assets/img/maths2.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 80</div>
                                <h3><a href="./courses/bsc-non-med.php">Bachelor of Science (Non-Medical)</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/bsc-non-med.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
                    ...
                    <li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/bca.php"><img src="./assets/img/bca.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 20</div>
                                <h3><a href="./courses/bca.php"> Bachelor of Computer Applications</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/bca.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
...
<li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/pgdca.php"><img src="assets/img/code.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 40</div>
                                <h3><a href="./courses/pgdca.php"> PG Diploma in Computer Applications</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/pgdca.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
...
<li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/ma-english.php"><img src="./assets/img/english.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 20</div>
                                <h3><a href="./courses/ma-english.php"> Master of Arts (English)</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/ma-english.php" class="readmore" style="text-decoration:none; color:red; " >Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
...
<li class="col-lg-3 col-md-4 ">
                        <div class="courses-item mb-30 hover-zoomin">
                            <div class="thumb fix">
                                <a href="./courses/ma-history.php"><img src="assets/img/history.png" alt="contact-bg-an-01"></a>
                            </div>
                            <div class="courses-content">
                                <div class="cat"><i class="fal fa-graduation-cap"></i> Available Seats: 20</div>
                                <h3><a href="./courses/ma-history.php">Master of Arts (History)</a></h3>
                                <!-- <p>B.Ed full form is Bachelor of Education, it is a 2 year undergraduate program that is done after graduation.</p> -->
                                <a href="./courses/ma-history.php" class="readmore">Read More <i class="fal fa-long-arrow-right"></i></a>
                            </div>
                            <div class="icon">
                                <img src="./img/cou-icon.png" alt="img">
                            </div>
...
<section  style="background-color: #A6192E; padding-top: 4rem; padding-bottom: 4rem;">
<div class="container">
    <div class="row">
    <div class="col-md-12">
     <div class="mtitle mb-5">
<h2 style="margin-top:-12rem">Government College Arki aims to create an atmosphere of excellence,<br /> hard work and professionalism in all its undertakings.</h2>
<!-- <p>Exploring Academic Interests and Career Goals</p> -->
</div>
</div>
    </div> 
  ...
  <div class="borders">
        <div class="image-section">
            <img src="assets/img/teachers/campus.png" class="img-width">
            <div class="bod"></div>
        </div>
    </div>
<h3 class="campus-style">campus Life</h3>
                    ...
                    <div class="col-lg-4 col-md-6  wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s" style="visibility: visible; animation-name: fadeInUp;">

                           
                        <div class="borders">
        <div class="image-section">
            <img src="assets/img/teachers/hostel.png" class="img-width">
            <div class="bod"></div>
      </div>
    </div>
<h3 class="campus-style">Hostel</h3>
                    ...
                    <div class="col-lg-4 col-md-6  wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="borders">
        <div class="image-section">
            <img src="assets/img/teachers/club.png" class="img-width">
            <div class="bod"></div>
        </div>
    </div>
<h3 class="campus-style">Club</h3>
...
<br>
  ...
  <div class="col-lg-4 col-md-6  wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="borders">
        <div class="image-section">
            <img src="assets/img/teachers/socity.png" class="img-width">
            <div class="bod"></div>
        </div>
    </div>
<h3 class="campus-style">  Societies </h3>
                    ...
                    <div class="col-lg-4 col-md-6  wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="borders">
        <div class="image-section">
            <img src="assets/img/teachers/code.png" class="img-width">
            <div class="bod"></div>
        </div>
    </div>
<h3 class="campus-style">   Code of Conduct</h3>
                    ...
                    <div class="col-lg-4 col-md-6  wow fadeInUp  animated" data-animation="fadeInUp" data-delay=".4s" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div class="borders">
        <div class="image-section">
            <img src="assets/img/teachers/cell.png" class="img-width">
            <div class="bod"></div>
        </div>
    </div>
<h3 class="campus-style">   Center and Cell</h3>
...
<section>
<div class="wcs-area bg-dark text-light mt-5 mb-5" style="margin-top: 0px !important;">
        <div class="container-full">
            <div class="row">
                <div class="col-md-6 thumb bg-cover" style="background-image: url(assets/img/homeb.png); min-height: 450px; background-size: cover;"></div>
                <div class="col-md-6 content" style="background: #ededed; align-content: center;">
                    <div class="site-heading text-left p-4" >
                        <!-- <h4>Why chose us</h4> -->
                        <h2 style="color:#000;">Find your circle. Spark your Inspiration.</h2>
                        <p class="text-white" style="font-size: 1.2rem; color:#000!important;">
                        Govt. College Arki, established in 1994, has proven itself to be the educational landmark of District Solan and is imparting education at the undergraduate level in all the three streams, viz., Science, Arts, Commerce   </p>
                    </div>
...
<!-- 
popup section onpage load -->
<div id="popup-overlay" class="popup-overlay"></div>
    <div id="popup" class="popup">
        <span id="close-popup-btn" class="close-btn">X</span>
        <h2><?php echo $popupTitle; ?> <img src="img/popup-img.jpg" style="width:600px;height:600px;"> </h2>
  ...
  <script type="text/javascript" src="sites/default/files/js/js_15FCBD_q-UtCl3aGeTHffmJLgXUVZ10zDRzzvDTu1PM.js"></script>
  <script type="text/javascript">
