...
<head>
  ...
  <title>Campus Life | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
              ...
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate">
                  <div class="hero__headline">
                    <h1 id="page-title">Campus Life</h1>
                  </div>

                  <div class="hero__image">
                    <img src="./assets/img/slider/capusb.jpeg" width="1600" height="1067" alt="" />
                  </div>
                </div>
              </section>
            </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">Campus Life</h2>
                  <p>The advent into college life is replete with a sense of exciting adventure in itself. Stepping outside the comfort of home and familial warmth is fused with a nervous enthusiasm to meet new people and manage things on one’s own. College life is all about new experiences and life on campus is a quintessential part of the comprehensive development of students, and the more varied the campus life, better are the opportunities for students to explore themselves.</p>

                  <p>Govt College Arki, Distric Solan, being an outstanding institution of excellence and prestigious college of HIMACHAL PRADESH has always held its head high with the stupendous diversity of students who flock to its campus. The potpourri of immensely talented students from all over area, right from the Arki, and whining Solan District of Himachal Pradesh, to far off areas of district, gives the college a truly pan-feel. The college is also a regular favourite figuring on the lists of the Himachal students, who join the Govt College Arki fraternity in impressive numbers every year. This institution has progressively emerged as one of the leading institution of higher learning in Himachal Pradesh with its sole motto of transformation of the students into awakened,responsible and accountable citizen. It is covered by 2(f) and 12(b) by UGC. The assorted array of students and the sheer variety of social and cultural life that their presence imbues the campus with, adds tremendously to the students’ cosmopolitan outlook and overall development. Most old students recall the time spent at college as the one marked by immense personal growth.</p>

                  <p>The exceptionally competent faculty at College is driven by the philosophy of nurturing opportunities of self-expression in all the students, and plays a cardinal role in maintaining an active and wide-ranging co-curricular domain via a host of societies to enable a wholesome development of every student in every way possible.</p>
                  </p>
                </div>
              </div>
            </section>
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding:3rem 3rem;">
    <div class="container">
      <div class="images-box">
        <img src="./assets/img/new/1.jpeg" style="width: 33%;">
        <img src="./assets/img/new/2.jpeg" style="width: 33%;">
        <img src="./assets/img/new/3.jpeg" style="width: 33%;">
      </div>
    </div>
  </div>
  <div class="container-fluid" style="background-color:#A6192E; padding-bottom:3rem; margin-bottom:4rem;">
    <div class="container">
      <div class="images-box">
        <img src="./assets/img/new/4.jpeg" style="width: 33%;">
        <img src="./assets/img/new/5.jpeg" style="width: 33%;">
        <img src="./assets/img/new/6.jpeg" style="width: 33%;">
      </div>
    </div>
  </div>
