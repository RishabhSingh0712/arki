...
<!-- Mirrored from www.oberlin.edu/about-oberlin/mission-and-values by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2024 16:53:43 GMT -->
<!-- Added by HTTrack -->
...
<head>
  ...
  <title>Vision and Mission | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-26311 node-type-advanced-page slid-closed">
  ...
  <!-- Header End -->
      ...
      <div class="container-fluid" style="background-color:#544345; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Vission & Mission<h1>
      </div>

          <div class="container margin-cusm">
                <div class="row" style="align-items: center;">
                  <div class="col">
                     <img src="./assets/img/new/vission.jpg" style="width: 100%;">
                    </div>
                   <div class="col">
                   <div class="starter-template">
                       <h2>Vision</h2>
                       <p class="lead">To be a key factor for the economic and social transformation of the people of Arki region.</p>
                     </div>
                     </div>
                </div>
          </div>
          ...
          <div class="container margin-cusm">
                <div class="row" style="align-items: center;">
                  <div class="col">
                       <div class="starter-template">
                           <h2>Mission</h2>
                           <p class="lead">To provide multi-dimensional holistic education to the students for the enlargement of intellectual and human dimensions.<br><br> To mentor students in their academic, research, and co-curricular pursuits to realize their true potential.<br><br> To promote diversity, ethical values, leadership etc. and provide enriching learning environment with ample co-curricular & social activities for an enhanced learning experience to usher a paradigm change in our world.</p>
                         </div>
                     </div>
                       <div class="col">
                           <img src="./assets/img/new/mission.jpg" style="width: 100%;">
                         </div>
                </div>
          </div>
...
<!-- Mirrored from www.oberlin.edu/about-oberlin/mission-and-values by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 15 May 2024 16:53:51 GMT -->
