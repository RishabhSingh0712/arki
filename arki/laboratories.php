...
<head>
  ...
  <title>Laboratories | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <main id="main-content">
    <div class="vertical-spacing--basic page-content-wrapper--basic" style="margin:0;">
        ...
        <div class="content">
          <div class="vertical-spacing--more">
            <div class="vertical-spacing--basic">
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate">
                  <div class="hero__headline">
                    <h1 id="page-title">Laboratories</h1>
                  </div>

                  <div class="hero__image">
                    <img src="./assets/img/slider/lab.jpg" width="1600" height="1067" alt="" />
                  </div>
                </div>
              </section>

              <section class="body-left-layout" aria-label="Introductory Content" style="padding: 25px 0px;">
                <div class="body-left-layout__content">
                  <div class="intro-text">
                    <h2>Laboratories</h2>
                    <p>
                      We provide the facility of laboratory to students where in controlled conditions they could perform scientific or technological research, experiments and measurement. There are ten well equipped Laboratories in the college. Two computer labs, Language Lab, Commerce Practical room, one botany, zoology, geography, physics and two chemistry labs are available.
                    </p>
                  </div>
                </div>
              </section>
             ...
             <div class="container">
              <h1 style="text-align:center; color:#A6192E;">Laboratories</h1>
              <div class="row">
                <div class="col-md-4"><img src="img/Laboratory Photographs/Botany Lab 1.jpg" style="width:350px; height:300px;border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Botany Lab</h2>
              </div>
                <div class="col-md-4"><img src="img/Laboratory Photographs/Chemistry Lab 2.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Chemistry Lab</h2></div>
                <div class="col-md-4">
                  <img src="img/Laboratory Photographs/Geography  lab2.jpg" style="width:350px; height:300px; border:4px solid red;">
                  <h2 style="text-align:center;margin-top:10px;">Geography Lab</h2></div>
              </div>
              <br>
              <div class="row">
                <div class="col-md-4"><img src="img/Laboratory Photographs/Geography Lab3.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Geography Lab</h2>
              </div>
                <div class="col-md-4"><img src="img/Laboratory Photographs/Physics Lab1.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Physics Lab</h2></div>
                <div class="col-md-4"><img src="img/Laboratory Photographs/Zoology Lab1.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Zoology Lab</h2></div>
              </div>
             </div>
              ...
              <section class="contrast-band contrast-band--strong-contrast" aria-label="Messaging Blocks">
                <div class="max-width-layout">
                  <div class="grid grid--300" data-col-gap="2x">
                    <div class="card-1">
                      <img src="./assets/img/slider/lab2.jpg" width="560" height="372" style="width: 100%; height: 100%;" />

                      <!-- <div class="card__content">
                        <div>
                          <h2>Leadership and Administration</h2>
                          <p>
                            The Board of Trustees is the governing body of the
                            college, ensuring that we achieve major goals and
                            uphold our mission. The president provides
                            day-to-day leadership and general supervision over
                            the functions of Oberlin, reporting to the board
                            and serving as member <em>ex officio</em>. Senior
                            staff oversee academic and administrative
                            functions of the college&nbsp;and advise and
                            support the work of the president.
                          </p>

                          <div class="lined-list lined-list--dotted">
                            <div class="item-list">
                              <ul class="">
                                <li class="first">
                                  <a href="about-oberlin/leadership-and-administration.html">Leadership and Administration Overview</a>
                                </li>
                                <li>
                                  <a href="president.html">Office of the President</a>
                                </li>
                                <li>
                                  <a href="general-counsel-and-secretary/trustees.html">Board of Trustees</a>
                                </li>
                                <li class="last">
                                  <a href="about-oberlin/one-oberlin.html">One Oberlin Initiative</a>
                                </li>
                              </ul>
                            </div>
                          </div>
                    ...
                    <div class="card-1">
                      <img src="./assets/img/slider/lab4.jpg" width="560" height="372" style="width: 100%; height: 100%;" />
