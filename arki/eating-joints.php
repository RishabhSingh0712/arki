...
<head>
  ...
  <title>Eating Joints | Government College Arki</title>
        ...
        <div class="content">
          <div class="vertical-spacing--less">
            <div class="vertical-spacing--basic">
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  <div class="hero__headline" style="align-items: center;">
                    <h1 id="page-title">Eating Joints</h1>
                  </div>

                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/canteenb.jpg" width="1600" height="1067" alt="" />
                  </div>
                </div>
              </section>
            </div>
            ...
            <div class="container" style="margin-bottom:2rem;">
                <div class="row" style="align-items: center;">
                   ...
                   <div class="starter-template">
                       <h2>Canteen</h2>
                       <p class="lead">The spacious structure of the College has separate dining areas for students and staff. It's often said that one's overall wellbeing-physical, emotional, and mental—is deeply intertwined with the quality of their dining experiences. The campus offers not only food for thought but also food for the body. The college canteen, the most frequently visited place on campus, provides the community with healthy, nutritious, and safe food at a reasonable price. Our College Canteen serve as more than just places to eat; It is where friendships are forged, conflicts are resolved, and ideas are exchanged. Whether over a shared meal or a simple cup of tea, students engage in discussions and brainstorming sessions that spark creativity for academic endeavors, social gatherings, and even late-night festivities.</p>
                     </div>
                     </div>
                     <div class="col">
                     <img src="./assets/img/new/canten.jpg" style="width: 100%;">
                    </div>
                </div>
          </div>

          <div class="container" style="background-color: #A6192E; padding: 25px 30px;">
                <div class="row">
                   <div class="col">
                   <div class="starter-template">
                       <p class="lead" style="text-align:center; color:#fff;">The campus boasts several eateries catering to diverse tastes and preferences. From the cherished Indian Coffee House, serving delectable Baghal Dhaam since the college's inception, to a spacious canteen offering a variety of North Indian delicacies, students are provided with an array of options to satisfy their culinary cravings . The creative menu, which includes breakfast, refreshments, and lunch, is carefully chosen to serve the nutritional requirements of the students. A special and attractive menu is available on days of seminars, conferences, and other programmes organized by the college. These dining spots are not just renowned for their savory fare but also serve as venues for creating enduring memories and fostering a sense of community.<br><br>

                       Furthermore, we prioritize the well-being of its students by ensuring appetizing meals to promote a balanced diet. Fruit juices, milkshakes, ice cream sundaes are available to cater to various preferences. The campus maintains the highest standards of cleanliness and hygiene, with round-the-clock cleaning and access to purified drinking water.
                       <br><br>
                       The menu rotation, overseen by a food committee comprising student representatives, administrative staff, canteen committee, and the principal, ensures that dining experiences remain fresh and appealing throughout the year.<br><br>
                       Overall, the dining facilities at GC Arki are more than just places to refuel; they are integral components of campus life, contributing to students' holistic well-being and enriching their college experience.</p>
            ...
            <!-- <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">Canteen</h2>
                  <p>The spacious structure of the College has separate dining areas for students and staff. It's often said that one's overall wellbeing-physical, emotional, and mental—is deeply intertwined with the quality of their dining experiences. The campus offers not only food for thought but also food for the body. The college canteen, the most frequently visited place on campus, provides the community with healthy, nutritious, and safe food at a reasonable price. Our College Canteen serve as more than just places to eat; It is where friendships are forged, conflicts are resolved, and ideas are exchanged. Whether over a shared meal or a simple cup of tea, students engage in discussions and brainstorming sessions that spark creativity for academic endeavors, social gatherings, and even late-night festivities.</p>

                  <p>The campus boasts several eateries catering to diverse tastes and preferences. From the cherished Indian Coffee House, serving delectable <strong>Baghal Dhaam</strong> since the college's inception, to a spacious canteen offering a variety of North Indian delicacies, students are provided with an array of options to satisfy their culinary cravings . The creative menu, which includes breakfast, refreshments, and lunch, is carefully chosen to serve the nutritional requirements of the students. A special and attractive menu is available on days of seminars, conferences, and other programmes organized by the college. These dining spots are not just renowned for their savory fare but also serve as venues for creating enduring memories and fostering a sense of community.</p>

                  <p>Furthermore, we prioritize the well-being of its students by ensuring appetizing meals to promote a balanced diet. Fruit juices, milkshakes, ice cream sundaes are available to cater to various preferences. The campus maintains the highest standards of cleanliness and hygiene, with round-the-clock cleaning and access to purified drinking water.</p>

                  <p>The menu rotation, overseen by a food committee comprising student representatives, administrative staff, canteen committee, and the principal, ensures that dining experiences remain fresh and appealing throughout the year.</p>

                  <p>Overall, the dining facilities at GC Arki are more than just places to refuel; they are integral components of campus life, contributing to students' holistic well-being and enriching their college experience.</p>
                </div>
              </div>
            </section>
          </div>
