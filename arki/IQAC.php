...
<head>
  ...
  <title>IQAC | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#544345; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">IQAC<h1>
      </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header" style="padding-top: 60px;">
                  <h2>IQAC Action Taken Report</h2><br>
                  <h4><a href="./assets/documents/IQAC-GDCArki.pdf">Click Here. (PDF)</a></h4>
                </div>
              </div>
            </section>
          </div>
