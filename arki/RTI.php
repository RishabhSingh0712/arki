...
<head>
  ...
  <title>RTI | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#544345; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">RTI<h1>
      </div>
        ...
        <div class="content">
          <div class="vertical-spacing--more">
            <div class="vertical-spacing--basic">
              ...
              <section class="max-width-layout" aria-labelledby="features-title" style="padding-top: 50px">
                <div class="items-row">
                  <div class="items-row__header">
                    <h2 id="features-title">Right to Information (2005)</h2>
                    ...
                    <hr /><br>
                    <h4>Objectives</h4>
                    <p>To ensure greater and more effective access to information under the control of public authorities.</p>
                    <p>To promote transparency and accountability in working of public institutions/organizations.</p><br>
                    <hr /><br>
                    <h4>Statutory provisions made for right to information</h4>
                    <p>Public Authority is under the obligation to provide information within 30 days from the date of request in normal cases or within 48 hours if information is a matter of life or liberty of a person.</p><br>
                    <hr /><br>
                    <h4>What does RIGHT TO INFORMATION mean?</h4>
                    <p>The right to Inspection of work, document records Taking notes, extracts, or certified copies of documents or records; Taking certified samples of material.</p><br>
                    <hr /><br>
                    <a href="./assets/documents/rtiform.pdf" style="text-decoration: none; padding: 10px 30px; background-color:#A6192E; color: #fff; border-radius: 3px;"><strong>Download Form</strong></a>&nbsp;&nbsp;
                    <a href="https://rtionline.gov.in/" style="text-decoration: none; padding: 10px 30px; background-color:#A6192E; color: #fff; border-radius: 3px;"><strong>RTI Website</strong></a>
                  </div>
                </div>
              </section>
            </div>
