...
<head>
  ...
  <title>Research | Government College Arki</title>
              ...
              <section class="" aria-label="Header Panel" style="height: 90%;">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  ...
                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/slider/research.jpg" style="width: 100%;" alt="" />
                  </div>
                </div>
              </section>
            </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">Research</h2>
                  <p>In research facility, Government Degree College Arki boasts a comprehensive array of cutting-edge equipment designed to facilitate groundbreaking scientific exploration. At the heart of our operations lies the BOD (Biochemical Oxygen Demand) incubator, a marvel of modern technology that provides a nurturing environment for a diverse array of biological specimens. The BOD (Biochemical Oxygen Demand) incubator plays a crucial role in our Zoology research laboratory, providing a specialized environment tailored to the needs of biochemical experiments and analyses.</p>
                  <p>Complementing our incubators are binocular telescopes enhancing our astronomical studies by offering enhanced magnification and clarity for celestial observation, supporting discoveries in cosmology, astrophysics, and planetary science. Binocular telescopes are also essential in zoological research, facilitating non-invasive field observations, species identification, population surveys, nesting studies, and wildlife health monitoring, contributing to comprehensive understanding and conservation of diverse animal species and ecosystems.</p>
                  <p>In our college research facility, we are equipped with a wide array of essential instruments that play crucial roles in various scientific studies. We have a pH meter which is indispensable tool, enabling us to accurately measure acidity or alkalinity levels in diverse solutions, essential for experiments spanning biology, chemistry, environmental science, and agriculture. We also have Electric balances provide precision in mass measurement down to microgram levels, facilitating quantitative analysis, formulation of solutions, and dosage calculations across scientific disciplines like Chemistry, Pharmacology, and materials science.</p>
                  <p>Moreover, Canon cameras serve as indispensable tools for high-resolution imaging, allowing detailed documentation of biological specimens, archaeological artifacts, and environmental phenomena. These instruments collectively contribute to the advancement of research in Biology, Archaeology, Ecology, Geology, Chemistry, and other scientific domains within our college research facility.</p>
                  <p>Last but certainly not least, our laboratory is fortified by the presence of autoclaves, stalwart guardians against microbial contamination. Through the power of high-pressure steam and elevated temperatures, these devices ensure that our equipment, glassware, and media remain pristine and free from harmful pathogens. By upholding the highest standards of sterility and hygiene, our autoclaves underpin the integrity and reliability of our research endeavors, safeguarding the validity of our findings and the welfare of our animal subjects. Together, these instruments form the backbone of our research facility, empowering us to push the boundaries of scientific knowledge.</p>
                </div>
              </div>
            </section>
          </div>
