...
<head>
  ...
  <title>NSS | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">NSS<h1>
      </div>
<div class="container-fluid" style="background: #ededed;">
      <div class="container" style="padding-top: 4rem;">
                <div class="row" style="align-items: center; padding-bottom: 30px;">
                   <div class="col">
                   <div class="starter-template">
                       <h2 style="margin-bottom: 1.5rem;">Active Sessions 2023-2024</h2>
                       <p class="lead point-text">7 NOV SHRAM DAAN - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/7-NOV-SHRAM-DAAN.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">EKTA DIWAS 2023 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/EKTA-DIWAS-2023.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">INTERNATIONAL YOGA DAY - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/INTERNATIONAL-YOGA-DAY.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">Kalash Yatra acitivites - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/Kalash-Yatra-acitivites.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">KARGIL VIJAY DIWAS - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/KARGIL-VIJAY-DIWAS.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NIC AT CHITKARA - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/NIC-AT-CHITKARA.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NORTH ZONE PRE RD CAMP 2023 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/NORTH-ZONE-PRE-RD-CAMP%202023.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NSS MEGA CAMP G.C. BANJAR - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/NSS-MEGA-CAMP-GC-BANJAR.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">Report of 1st october 2023 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/Report-of-1st-october-2023.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">STATE PRE RD CAMP BILASPUR - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/STATE-PRE-RD-CAMP-BILASPUR.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">SWACHH DIWALI SIGNATURE CAMPAIGN - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/SWACHH-DIWALI-SIGNATURE-CAMPAIGNE.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">TRAINING AND WORKSHOP AT HIPPA - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/TRAINING-WORKSHOP-AT-HIPPA.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">TREE PLANTATION DRIVE - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/2023-24/TREE-PLANTATION-DRIVE.pdf" style="color: #A6192E;">Click Here</a></span></p>
                     </div>
                     </div>
                     <div class="col" style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                     <img src="assets/img/teachers/dhan-dev.png" style="width: 70%; border: 2px solid; padding: 0.5rem;">
                     <p style="padding-top: 12px; font-size: 18px; text-align: center; font-weight: 600;">DR. DHAN DEV SHARMA <br>N.S.S. P.O. UNIT-I</p>
                    </div>
                </div>
                <hr>
          </div>
          ...
          <div class="container" style="padding-top: 4rem;">
                <div class="row" style="align-items: center; padding-bottom: 30px;">
                   <div class="col">
                   <div class="starter-template">
                       <h2 style="margin-bottom: 1.5rem;">Active Sessions 2022-2023</h2>
                       <p class="lead point-text">14th Dec 2022 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/14th-dec-2022.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">16TH OCT 2022 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/16th-oct-2022.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">CLEANLINESS DRIVE ON 17 OCT 2022 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/CLEANLINESS-DRIVE-ON-17-OCT-2022.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">COLLEGE CLEANLINESS DRIVE 17 OCT 2022 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/COLLEGE-CLEANLINESS-DRIVE-17-OCT-2022.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">CONSTITUTION DAY CELEBRATION - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/CONSTITUTION-DAY-CELEBRATION.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NIC AT BAREILLY U.P. - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/NIC-AT-BAREILLY-U.P..pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NIC AT BHIWANI HARYANA - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/NIC-AT-BHIWANI-HARYANA.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NIC AT BHIWANI HARYANA - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/NIC-AT-BHIWANI-HARYANA.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">NIC AT PATIALA - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/NIC-AT-PATIALA.pdf" style="color: #A6192E;">Click Here</a></span></p>

                     </div>
                     </div>
                     <div class="col" style="display: flex; justify-content: space-around; flex-direction: column; align-items: center;">
                     <img src="assets/img/teachers/suman.jpg" style="width: 70%; border: 2px solid; padding: 0.5rem;">
                     <p style="padding-top: 12px; font-size: 18px; text-align: center; font-weight: 600;">DR. DHAN DEV SHARMA <br>N.S.S. P.O. UNIT-I</p>
                    </div>
                </div>
                <hr>
          ...
          <div class="container" style="padding-top: 4rem;">
                <div class="row" style="align-items: center; padding-bottom: 30px;">
                   <div class="col">
                   <div class="starter-template">
                       <h2 style="margin-bottom: 1.5rem;">Special Camps</h2>
                       <p class="lead point-text">SEVEN DAYS SPECIAL CAMP 2023-24 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/SEVEN-DAYS-SPECIAL-CAMP-2023-24.pdf" style="color: #A6192E;">Click Here</a></span></p>

                       <p class="lead point-text">SPECIAL CAMP REPORT 2022-23 - <span><a href="https://gcarki.hp.gov.in/arki-college/assets/documents/nss/SPECIAL-CAMP-REPORT-2022-23.pdf" style="color: #A6192E;">Click Here</a></span></p>
