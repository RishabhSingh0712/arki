...
<head>
  ...
  <title>IT Services | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <main id="main-content" style="background-color: #f2f2f2;">
    <div class="vertical-spacing--basic page-content-wrapper--basic" style="margin: 0; padding-bottom: 4rem;">
              ...
              <section class="" aria-label="Header Panel" style="height: 90%;">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  <div class="hero__headline">
                    <h1 id="page-title">IT Services</h1>
                  </div>

                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/slider/it-service.jpg" style="width: 100%;" alt="" />
                  </div>
                </div>
              </section>
            </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">IT Services</h2>
                  <p>With the assistance of the faculty of self-financing courses, Information Technology fosters the spirit of innovation through technology and provides the resources and infrastructure to connect students and staff to their goals. Students and employees can access printing, copying and scanning services available through multifunction devices that can be found across the College.</p>
                  <ul>
                    <li>We offer secure wireless access points at all campuses, and in public spaces throughout the campus, that provide mobile users with convenient and easy access to the campus network and the Internet.</li><br>
                    <li>We are committed to providing users with a safe and secure computing environment that protects College’s electronic resources and the privacy of individuals.</li><br>
                    <li>Students can take advantage of the open-access computer labs in the library and the language laboratory for the academic and practical work.</li><br>
                    <li>Prior to the start of each academic semester, new students can attend an IT Information Session. These one-hour, online sessions will offer practical information and live demos showing attendees how to access and set up many IT services, including: downloading software, setting up your email, Filling up of registration form, admission form , changing your password, and more.</li>
                  </ul>
                </div>
              </div>
            </section>
