...
<head>
  ...
  <title>About Us | Government College Arki</title>
      ...
      <div id="block-system-main" class="block block-system">
        <div class="content">
          <div class="vertical-spacing--more">
            <div class="vertical-spacing--basic design-cusm">
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate">
                  <div class="hero__headline">
                    <h1 id="page-title">About G.C. Arki</h1>
                  </div>

                  <div class="hero__image">
                    <img src="./assets/img/slider/3.jpg" width="1600" height="1067" alt="" />
                  </div>
                </div>
              </section>

              <section class="body-left-layout" aria-label="Introductory Content">
                <div class="body-left-layout__content">
                  <div class="intro-text">
                    <p class="text-white-cusm">
                      Located in pristine, picturesque surroundings at Batal
                      Ghatti, District Solan, H.P.-173208, that is 4 kms. from
                      Arki on the Arki - Kunihar road, the college offers a
                      very conducive environment for learning and envelopes
                      even those who have the propensity to go wayward.
                    </p>
                  </div>
                </div>
              </section>
            ...
            <div class="container">
                <div class="row" style="align-items: center;">
                  <div class="col">
                     <img src="./assets/img/new/7(2).jpeg" style="width: 100%;">
                    </div>
                   <div class="col">
                   <div class="starter-template">
                       <p class="lead">The 15th of July 1994,the day this institute came into existence, will always be remembered as a red letter day by the people of Arki as the college has brought higher education to their doorstep and their wards no more go to cities for the purpose. The number of students has exponentially risen from 110 in the first batch in 1994 to 1149 in 2018. It possesses adequate infrastructure in terms of class-rooms, laboratories, a library, a well-equipped computer lab with Wi-Fi connection and a playground etc. It has separate Arts, Science and Administrative Blocks. To cater to the needs of SC and ST students (only girls), a four-storeyed hostel has also been constructed.</p>
                     </div>
                     </div>
                </div>
            </div>
            ...
            <div class="container" style="background-color: #A6192E; padding: 25px 30px;">
                <div class="row">
                   <div class="col">
                   <div class="starter-template">
                       <p class="lead" style="text-align:center; color:#fff;">The foundation stone of the college building was laid by the then Hon'ble Chief Minister of H.P., Shri Virbhadra Singh in 1996, and he sanctioned a substantial amount of three crores for the construction of the Science Block. The Arts Block was dedicated to the college by Gujrat Ambuja Cement Ltd. Before moving into the sprawling campus at Batal Ghati in 1998, the classes were initially run from the premises of Govt. Sr. Secondary School Arki for two months and then necessary alterations were made in a store of I & PH Department to house the college. Though the building did not fully cater to the needs of a growing college, yet the lack of sufficient accommodation did not dampen the spirits of devoted teachers and inquisitive seekers of learning.<br><br>

The moto of the college which means “We taste immortality through knowledge” reflects the vision of the founder members of the college. They envisioned that the future would belong to people believing in meritocracy and not mediocrity, and in keeping with their dream the students now realise with all earnestness that 'quality' and not 'quantity' is the catch word in the 21st century. The excellent university results year after year and the Alumni who are making their presence felt in all walks of life prove that the students walk in the footprints of their predecessors who gained 'immortality' exploring the vast horizons of knowledge. They carry forth a legacy which exudes more responsibility than privileges. It is hoped that the college fraternity will consider it sacrosanct to keep the reputation of the institution unsullied and always remember H.W. Longfellow's words:</p>
<p class="lead" style="text-align:center; color:#fff;"><b><i>Lives of great men, all remind us We can make our lives sublime And departing leave behind us Footprints on the sands of time.</i></b></p>
                     </div>
                     </div>
                </div>
            </div>
            ...
            <div class="container">
            <h2 style="padding-top: 2.5rem;">Facilities Provided By The College For Staff & Students</h2>
            </div>
            <div class="container" style="margin-top: -45px;!important">
                <div class="row" style="column-gap: 40px; margin-top: 2rem;">
                  <div class="col-sm box-cusm">
                      A well stocked Library
                  </div>
                  <div class="col-sm box-cusm color-cusm">
                ...
                <div class="row" style="column-gap: 40px; margin-top: 2rem;">
                  ...
                  <div class="col-sm box-cusm"> 
                       Separate Parking area for Staff & students
                  </div>
                </div>
                <div class="row" style="column-gap: 40px; margin-top: 2rem;">
                    <div class="col-sm box-cusm"> 
                       Well-equipped Laboratories in Physics, chemistry, Botany, Zoology & Geography
                     </div>
                  <div class="col-sm box-cusm color-cusm">
                      Staff Room & separate well-equipped and internet connected teacher cabins
                  </div>
                </div>
            </div>
