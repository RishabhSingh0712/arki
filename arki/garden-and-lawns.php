...
<head>
  ...
  <title>Garden and Lawns | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed" >
  ...
  <main id="main-content" style="   background-color: #e7e6e6; padding-bottom:4rem;">
    <div class="vertical-spacing--basic page-content-wrapper--basic" style="margin-bottom:0px!important">
              ...
              <section class="" aria-label="Header Panel">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  <div class="hero__headline" style="align-items: center;">
                    <h1 id="page-title">Garden and Lawns</h1>
                  </div>

                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/slider/garden.jpg" width="1600" height="1067" alt="" />
                  </div>
                </div>
              </section>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">Garden and Lawns</h2>
                  <p>The College gardens with her velvet lawns, assorted plants, flowers and trees, provide the ideal environment for contemplation. Choosing a college for higher education is a significant decision, often accompanied by a considerable amount of stress due to various factors such as change and uncertainty. Alongside considerations like fees, living expenses, and academic reputation, the appeal of a serene and aesthetically pleasing campus holds its own importance in ensuring students comfort and happiness. A beautiful campus not only promotes a healthy lifestyle outside of the classroom but also fosters a connection to nature, encouraging students to reflect on themselves and their place in the world beyond materialistic pursuits.</p>

                  <p>Government Degree College Arki understands the significance of a welcoming campus environment and takes pride in its picturesque surroundings. The garden is thus a source of great pride for GC Arki. The college boasts extensive green spaces adorned with lush trees, providing ample areas for sports and recreational activities. <strong>The main ground</strong> serve as venues for various sporting events and practices, including kho-kho, parade, athletics, volleyball, and street plays. During special occasions, these grounds come alive with the excitement of festivals, college nights, and other celebrations.</p>

                  <p>The Gooseberry, Jamun, Rudraksh, Aloevera, Bhedha, Guava, Aloevera, Ashwagandha, and Roses in the College Garden create a tranquil atmosphere for students to unwind and socialize. Adjacent to the Science block, the Umbrella Garden offers comfortable seating under the shade of trees, providing an ideal spot for students to relax between classes.</p>

                  <p>Overall, Government Degree College Arki recognizes the importance of providing students with a visually appealing and inviting campus environment, contributing to their overall well-being and enhancing their college experience. <strong>The Eco club</strong> offers a unique opportunity for aesthetic satisfaction to those interested in gardening and conservation. The wide stretches of the back lawns are especially inviting in the winter, when the sun glistens on the moist grass.</p>
                </div>
              </div>
            </section>
          </div>
