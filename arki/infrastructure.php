...
<head>
  ...
  <title>Infrastructure | Government College Arki</title>
              ...
              <section class="" aria-label="Header Panel" style="height: 90%;">
                <div class="hero hero--with-caption" data-drama-level="moderate" style="height: 90%;">
                  ...
                  <div class="hero__image" style="height: 90%;">
                    <img src="./assets/img/slider/infa.jpg" style="width: 100%;" alt="" />
                  </div>
                </div>
              </section>
            </div>
            ...
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                <div class="items-row__header">
                  <h2 id="features-title">Infrastructure</h2>
                  <p class="lead">The College has hostel facilities. The hostels and the rooms are technically designed to suit the students’ requirements as the three years of their stay during graduation are very important in their lives. There are no compromises in the quality and standards of the living space and the facilities provided. The hostel facility helps the students in utilizing their valuable time for studies and revisions during the tenure. However, the building is in the temporary possession of CCI (child care Institution).</p>
                  <p class="lead">The computers are updated with required licenses in order to let the students avail the benefits of various softwares in their entirety. The college also provides wireless internet connectivity, which students can access on their personal phones and laptops and which works unimpededly throughout the entire campus. The bandwidth of the college effectively handles maximum number of requests and does not shut or slow down.</p>
                  <p class="lead">Since the students spend a good part of their day as well as their college lives, in classrooms and classrooms are where most of the academic exchange transpires, it is only desirable that they ought to be inviting and comfortable enough for the students to settle in. The college has immaculately designed academic blocks with well furnished, airy classrooms. The students have enough room inside the classrooms for comfortable, spacious seating and outside the classrooms to venture into the corridors between classes to take short breaks or to commute to their classes. Some classrooms have been converted into smart classrooms, complete with projectors and internet consoles, which complete with integrated audio-visual teaching aids for presentations and lectures etc. are the most favourable to creating an ambience for focussed, fruitful and vigorous discussions. These classrooms are also used as venues for holding special sessions or mini-seminars on areas pertinent to students across streams like business communication, life skills, teamwork etc.</p>
                  </div>

                  <div class="container" style="margin-top:2rem; background-color: #A6192E;">
                <div class="row" style="align-items: center; margin: 25px;">
                   <div class="col">
                   <div class="starter-template">
                       <h2 style="color:#fff;">Cyber Cafe</h2>
                       <p class="lead" style="color:#fff;">The cyber café facility is available in the college to cater to students’ needs. This is especially handy when the students require filling forms advertised by different government and non govt. agencies. This is run by students and the staff of self-financing courses on no-profit and no-loss basis.</p>

                       <h2 style="color:#fff;">Parking Area</h2>
                       <p class="lead" style="color:#fff;">There is a large, designated car parking for members of staff and a separate parking area for students that can accommodate several cars and bikes at a time.</p>                      </div>
                     </div>
                     <div class="col">
                     <img src="./assets/img/slider/parking.jpg" style="width: 100%;">
                    </div>
                </div>
          </div>
...
<br><br><br>
    <section class="max-width-layout py-top-section" aria-labelledby="features-title">
             <div class="container">
              <h1 style="text-align:center; color:#A6192E;">Infrastructure</h1>
              <div class="row">
                <div class="col-md-4"><img src="img/Infrastructure Photographs/Canteen.jpg" style="width:350px; height:300px;border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Canteen</h2>
              </div>
                <div class="col-md-4"><img src="img/Infrastructure Photographs/Conference Hall.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Conference Hall</h2></div>
                <div class="col-md-4">
                  <img src="img/Infrastructure Photographs/Language Lab.jpg" style="width:350px; height:300px; border:4px solid red;">
                  <h2 style="text-align:center;margin-top:10px;">Language Lab</h2></div>
              </div>
              <br>
              <div class="row">
                <div class="col-md-4"><img src="img/Infrastructure Photographs/Library1.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Library1</h2>
              </div>
                <div class="col-md-4"><img src="img/Infrastructure Photographs/Multipurpose Hall.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Multipurpose Hall</h2></div>
                <div class="col-md-4"><img src="img/Infrastructure Photographs/Smartclassroom.jpg" style="width:350px; height:300px; border:4px solid red;">
                <h2 style="text-align:center;margin-top:10px;">Smartclassroom</h2></div>
              </div>
             </div>
