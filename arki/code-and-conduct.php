...
<head>
  ...
  <title>Code and Conduct | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Code and Conduct<h1>
      </div>
          ...
          <div class="vertical-spacing--more">
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                ...
                <h2>View Now</h2>
                  <h4 style="margin-top: 1.5rem;"><a href="./assets/documents/code-of-conduct.pdf" style="color: #fff; background-color: #A6192E; padding: 5px 15px; border-radius: 3px; margin-top:1rem;">Click Here.</a></h4>
                </div>
              </div>
            </section>
          </div>
