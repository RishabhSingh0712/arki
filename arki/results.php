...
<head>
  ...
  <title>Results | Government College Arki</title>
...
<body class="html not-front not-logged-in no-sidebars page-node page-node- page-node-16 node-type-landing-page slid-closed">
  ...
  <div class="container-fluid" style="background-color:#A6192E; padding: 7rem 0;">
        <h1 style="color:#fff; text-align:center;">Results<h1>
      </div>
          ...
          <div class="vertical-spacing--more">
            <section class="max-width-layout" aria-labelledby="features-title">
              <div class="items-row">
                ...
                <div class="items-row__header" style="padding-top: 60px;">
                  <h4>BA (Annual) - Ist Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/ba-1st-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BA (Annual) - IInd Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/ba-2nd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BA (Annual) - IIIrd Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/ba-3rd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BSC(Annual) - Ist Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/bsc-1st-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BSC(Annual) - IInd Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/bsc-2nd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BSC(Annual) - IIIrd Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/bsc-3rd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BCOM(Annual) - Ist Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/bcom-1st-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BCOM(Annual) - IInd Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/bcom-2nd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BCOM(Annual) - IIIrd Year Exam - 2022-2023&nbsp;&nbsp;<a href="./assets/documents/results/bcom-3rd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BCA - Ist Sem Exam - 2023-2024&nbsp;&nbsp;<a href="./assets/documents/results/bca-1st-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br>
                  <h4>BCA - IIIrd Sem Exam - 2023-2024&nbsp;&nbsp;<a href="./assets/documents/results/bca-3rd-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                  <br> 
                  <h4>BCA - Vth Sem Exam - 2023-2024&nbsp;&nbsp;<a href="./assets/documents/results/bca-5th-result.pdf" style="color: #A6192E;">Click Here. (PDF)</a></h4>
                </div>
              </div>
            </section>
          </div>
